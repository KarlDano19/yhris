        ...
        <div className='mt-10 grid grid-cols-1 md:grid-cols-3 md:gap-x-12'>
          <div className='grid-item mt-4 md:mt-0'>
            ...
            <div className='mt-2'>
              <input
                type='email'
                {...register('basicInfo.email', { required: true })}
                id='email'
          ...
          <div className='grid-item mt-4 md:mt-0'>
            ...
            <div className='mt-2'>
              <input
                type='number'
                {...register('basicInfo.phone', { required: true })}
                id='mobile-num'
          ...
          <div className="grid-item md:col-span-1">
            ...
            <div className="mt-2">
              <input
                type="text"
                {...register("basicInfo.contactPersonName", { required: true })}
                id="name"
                className="rounded-md w-full border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:black sm:text-sm sm:leading-6"
                tabIndex={3}
              />
          ...
          <div className="grid-item mt-4 md:mt-0 md:col-span-2">
            ...
            <div className="mt-2">
              <input
                type="text"
                {...register("basicInfo.contactPersonAddress", { required: true })}
                id="address"
                className="rounded-md w-full border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:black sm:text-sm sm:leading-6"
                tabIndex={4}
              />
          ...
          <div className="grid-item mt-4">
            ...
            <div className="mt-2">
              <input
                type="number"
                {...register("basicInfo.contactPersonAge", { required: true })}
                id="age"
                className="rounded-md w-full border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:black sm:text-sm sm:leading-6"
                tabIndex={5}
              />
          ...
          <div className="grid-item mt-4">
            ...
            <div className="mt-2">
              <input
                type="number"
                {...register("basicInfo.contactPersonMobile", { required: true })}
          ...
          <div className="grid-item mt-4">
            ...
            <div className="mt-2">
              <input
                type="text"
                {...register("basicInfo.contactPersonRelationship", { required: true })}
                id="relationship"
                className="rounded-md w-full border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:black sm:text-sm sm:leading-6"
                tabIndex={7}
              />
