            ...
            <div className='mt-2'>
              <ul>
                ...
                <div className='space-y-3'>
                  <p className='text-sm'>
                  We, at The ABBA Initiative, OPC (ABBA), the parent company of YAHSHUA Outsourcing Worldwide Inc. (YAHSHUA), its services arm, collectively referred to as YAHSHUA-ABBA, highly regard the privacy of our clients or customers, suppliers or vendors, business or industry partners, employees, interns, shareholders or investors, and by extension, the community we operate in.
                  </p>
                  <p className='text-sm'>
