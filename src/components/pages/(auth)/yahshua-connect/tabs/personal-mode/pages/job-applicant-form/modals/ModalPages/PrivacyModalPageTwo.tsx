          ...
          <div className='my-3 text-left sm:mt-3 px-6'>
            <div className='mt-2'>
              <ul>
                ...
                <div className='space-y-3'>
                  <p className='text-sm'>
                  We exclusively utilize tokens for user and web browser identification to facilitate authentication when visiting our website, and we do not use any other cookies for this or for any other purpose.
                  </p>
                </div>
              </ul>
            </div>
