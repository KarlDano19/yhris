...
export default function SendContractModal({
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    if (isOpen && selectedOrientId) {
      ...
      orientItemCopy[itemIndex].sendContract.subject = data.subject;
      orientItemCopy[itemIndex].sendContract.to = tagsTo;
      ...
      const callbackReq = {
        onSuccess: () => {
          // Clear newly added items when contract is sent
          handleContractSent();
  ...
  const handleContractSent = () => {
    // Clear newly added items when contract is sent
    // This ensures that the "New" grouping is reset after successful contract sending
  };
