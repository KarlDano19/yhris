      ...
      <Dialog as='div' className='relative z-10' initialFocus={cancelButtonRef} onClose={() => customCloseModal()}>
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
            ...
            >
              <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 w-1/2'>
                ...
                <div className='text-xl px-20 text-center'>
                  <p className='text-xl text-gray-600 font-bold'>
                    Unlock this (and a whole lot more) by <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#FA7417] to-[#FABE23]'>upgrading to YAHSHUA HRIS Premium</span> — so you can automate workflows, access advanced tools, and make HR easier than ever.
                  </p>
                </div>
                <div className='flex justify-center w-full px-4 space-x-8 pt-10 pb-7'>
                  <span className='flex w-full rounded-md shadow-sm sm:w-auto'>
                    <button
                      ...
                      onClick={() => {
                        window.location.href = '/manage-subscriptions#active-plans';
                      }}
                    >
                      Go Premium
                    </button>
