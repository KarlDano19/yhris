...
import useDeleteWorkEnvironmentRequest from '../hooks/useDeleteWorkEnvironementRequest';
...
export default function DeleteWemRequestModal({
  refetch,
  isOpen,
  setIsOpen,
}: {
  ...
  const { mutate, isLoading } = useDeleteWorkEnvironmentRequest();
