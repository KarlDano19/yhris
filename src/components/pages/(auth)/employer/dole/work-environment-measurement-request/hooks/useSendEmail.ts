...
export async function sendEmail(data: any) {
  try {
    ...
    if (data instanceof FormData) {
      ...
      // Add work_environment_measure_id if provided
      if (data.work_environment_measure_id) {
        formData.append("work_environment_measure_id", data.work_environment_measure_id.toString());
      }
    }
