...
export default function EditEmployeeCompensationLogModal({
  ...
  // Employee dropdown navigation state
  ...
  const onSubmit = handleSubmit((data: any) => {
    ...
    mutate({ employee_compensation_logbook_id: isOpen.id, data: data }, callbackReq);
  });
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div className='mt-5 sm:mt-4 sm:flex sm:flex-row-reverse px-4'>
                    <button
                      ...
                      disabled={isLoadingEditEmployeeCompensationLogbook}
                    >
                      {isLoadingEditEmployeeCompensationLogbook && (
                        <div role='status'>
                          <svg
                            aria-hidden='true'
                      ...
                      {!isLoadingEditEmployeeCompensationLogbook && 'Save'}
                    </button>
                    <button
                      type='button'
