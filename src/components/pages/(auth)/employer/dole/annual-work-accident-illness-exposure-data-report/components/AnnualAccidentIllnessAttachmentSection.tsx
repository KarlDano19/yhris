...
interface AnnualAccidentIllnessAttachmentSectionProps {
...
export default function AnnualAccidentIllnessAttachmentSection({
  pdfAttachment,
  onViewAttachment,
  onAttachmentUpload,
  onRemoveAttachment,
  attachment,
  attachmentExist
}: AnnualAccidentIllnessAttachmentSectionProps) {
