...
export async function sendEmail(data: any) {
  try {
    ...
    if (data instanceof FormData) {
      ...
      // Add health_and_safety_report_id if provided
      if (data.health_and_safety_report_id) {
        formData.append("health_and_safety_report_id", data.health_and_safety_report_id.toString());
      }
    }
