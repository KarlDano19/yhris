...
interface HealthAndSafetyOrganizationAttachmentSectionProps {
...
export default function HealthAndSafetyOrganizationAttachmentSection({
  pdfAttachment,
  onViewAttachment,
  onAttachmentUpload,
  onRemoveAttachment,
  attachment,
  attachmentExist
}: HealthAndSafetyOrganizationAttachmentSectionProps) {
