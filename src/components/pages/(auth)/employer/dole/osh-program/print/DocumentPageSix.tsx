...
const DocumentPageSix: React.FC<DocumentPageSixProps> = ({ data, isMultiPage = false }) => {
    ...
    >
      ...
      <div className="mb-4">
        ...
        <div className="ml-4 space-y-2">
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-600 ml-2">(Name of Building owner or his/her representative such as the building administrator)</span>
          </div>
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-600 ml-2">(Name of Safety officer appointed by the Chairperson)</span>
          </div>
          <div className="flex items-center">
          ...
          <div className="ml-4 space-y-1">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600">(Name of 2 safety officers from the building selected to the Joint OSH Committee)</span>
            </div>
            <div className="flex items-center">
              <span className="text-sm text-gray-700 mr-2">•</span>
              <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] mr-2">
              ...
              <span className="text-sm text-gray-600">(Name of two (2) workers&apos; representatives one from which must be from a union if organized from any establishments under the building)</span>
            </div>
          </div>
        </div>
      ...
      <div className="mb-4">
        <div className="flex items-center mb-2">
          <span className="text-sm text-gray-700 mr-2">Safety and Health Committee Minutes/Reports submitted to DOLE (pls attach latest OSH committee minutes/report)</span>
        </div>
        <div className="ml-4 space-y-1">
          <div className="flex items-center">
      ...
      <div className="mb-4 flex-1">
        ...
        <div className="mb-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              <span className="text-sm font-medium text-gray-700 mr-2">Personnel:</span>
              <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
                {/* Health personnel data would be displayed here */}
              </div>
            </div>
            <div className="flex items-center">
              <span className="text-sm font-medium text-gray-700 mr-2">Facilities:</span>
              <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
