    ...
    >
      ...
      <div className="mb-4">
        <div className="space-y-2">
          <div className="flex items-center">
            ...
            <span className="text-xs text-gray-700">How many treatment rooms/first aid rooms are existing in your company?</span>
          ...
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">How many Clinics in the workplace?</span>
            <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
          ...
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">What hospital(s) are you affiliated with?</span>
            <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2 ml-4">
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">Drug-free Workplace in compliance to RA 9165</span>
          </div>
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">Human Immunodeficiency Syndrome (HIV/AIDS) in compliance to (RA 8504) RA 11166</span>
          </div>
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">Tuberculosis in compliance to EO 187-03</span>
          </div>
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">Hepatitis B in compliance to DOLE Advisory No. 05 Series of 2010</span>
          </div>
          <div className="flex items-center">
            <span className="text-xs text-gray-700 mr-2">•</span>
            <span className="text-xs text-gray-700">Mental Health in compliance to RA 11036</span>
          </div>
        </div>
        <p className="text-xs text-gray-700 mt-2">Refer to Annex A..</p>
      </div>
          ...
          <p className="text-xs text-gray-700 mb-2">
            <strong>(a)</strong> For establishments with less than ten workers and low risk establishments with ten (10) to fifty (50) workers. - A SO1 shall establish an OSH committee composed of the following:
              ...
              <div className="flex items-center">
                ...
                <span className="text-xs text-gray-600 ml-2">(Name of Company owner or manager)</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="text-xs text-gray-600 ml-2">(Safety officer of the workplace)</span>
              </div>
              <div className="flex items-center">
                <span className="text-xs font-medium text-gray-700 mr-2">Member:</span>
                <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
                  {data.member_less_than_ten}
                </div>
                <span className="text-xs text-gray-600 ml-2">(Name of at least one (1) worker, preferably a union member, if organized)</span>
              </div>
            </div>
        </div>
        ...
        <div className="mb-3">
          <p className="text-xs text-gray-700 mb-2">
            <strong>(b)</strong> For medium to high risk establishments with ten (10) to fifty (50) workers and low to high risk establishments with fifty-one (51) workers and above. - The OSH committee of the covered workplace shall be composed of the following:
                      ...
                      <div className="ml-4 space-y-2">
              <div className="flex items-center">
                <span className="text-xs font-medium text-gray-700 mr-2">Ex-officio chairperson:</span>
                <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
                  {data.chairperson_medium_to_high}
                </div>
                <span className="text-xs text-gray-600 ml-2">(Name of Employer or his/her representative)</span>
              </div>
              <div className="flex items-center">
                <span className="text-xs font-medium text-gray-700 mr-2">Secretary:</span>
                <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] ml-2">
                ...
                <span className="text-xs text-gray-600 ml-2">(Name of Safety officer of the workplace)</span>
              </div>
              <div className="flex items-center">
                <span className="text-xs font-medium text-gray-700 mr-2">Ex-officio members:</span>
              </div>
              <div className="ml-4 space-y-1">
                <div className="flex items-center">
                  ...
                  <span className="text-xs text-gray-600">(Name of Certified first-aider/s)</span>
                </div>
                <div className="flex items-center">
                  <span className="text-xs text-gray-700 mr-2">•</span>
                  <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] mr-2">
                  ...
                  <span className="text-xs text-gray-600">(Name of OH nurse)</span>
                </div>
                <div className="flex items-center">
                  <span className="text-xs text-gray-700 mr-2">•</span>
                  <div className="border-b border-gray-300 flex-1 pb-1 min-h-[16px] mr-2">
                  ...
                  <span className="text-xs text-gray-600">(Name of OH dentist, and OH physician, as applicable)</span>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <span className="text-xs text-gray-600 ml-2">(Name of Safety officers representing the contractor or subcontractor, as the case may be)</span>
              </div>
            </div>
        </div>
      </div>
      ...
      <div className={isMultiPage ? "relative mt-auto pt-8" : "mt-auto pt-8"}>
        <span className="text-xs text-gray-600">Page | 5</span>
      </div>
    </div>
  );
};
