  ...
  return (
    <>
      ...
      <div className="mb-4">
        ...
        <p className="text-xs font-bold text-gray-700 mt-2">Refer to Annex A..</p>
      </div>
          ...
          <div className="ml-4 space-y-3">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of Company owner or manager)</div>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Safety officer of the workplace)</div>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of at least one (1) worker, preferably a union member, if organized)</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="ml-4 space-y-3">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of Employer or his/her representative)</div>
              </div>
            </div>
            <div className="flex items-start">
              <span className="text-xs font-medium text-gray-700 mr-2">Secretary:</span>
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of Safety officer of the workplace)</div>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of Certified first-aider/s)</div>
                <div className="border-b border-gray-300 pb-1 min-h-[16px] mt-2">
                  {data.ex_officio_members_1}
                </div>
                <div className="text-xs text-gray-600 mt-1">(Name of OH nurse)</div>
                <div className="border-b border-gray-300 pb-1 min-h-[16px] mt-2">
                  {data.ex_officio_members_2}
                </div>
                <div className="text-xs text-gray-600 mt-1">(Name of OH dentist, and OH physician, as applicable)</div>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">(Name of Safety officers representing the contractor or subcontractor, as the case may be)</div>
                <div className="border-b border-gray-300 pb-1 min-h-[16px] mt-2">
                  {data.members_2}
                </div>
                <div className="text-xs text-gray-600 mt-1">Name of workers&apos; representatives who shall come from the union, if the workers are organized, or elected workers through a simple vote of majority, if they are unorganized.</div>
              </div>
            </div>
          </div>
        </div>
