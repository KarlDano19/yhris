    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          {/* Sub-section 1. Failure to wear Personal Protective Equipment */}
          <div className="mb-4">
            <h4 className="text-sm font-semibold text-gray-900 mb-2">
              Sub-section 1. Failure to wear Personal Protective Equipment at construction site or where specified
            </h4>
      ...
      <div className={isMultiPage ? "mt-8" : "mt-auto"}>
        <span className="text-sm text-gray-600">Page | 10</span>
      </div>
    </div>
  );
};
