...
const DocumentPageNine: React.FC<DocumentPageNineProps> = ({ data, isMultiPage = false }) => {

  return (
    <div
      className="bg-white text-black font-sans text-sm leading-tight w-full h-full p-8"
      style={{
    ...
    >
      ...
      <div className="mb-6">
        <div className="border border-gray-300">
          ...
          {[
            {
              facility: 'Suitable living accommodation (if applicable)',
              provided: data.suitable_living_accommodation,
              remarks: data.suitable_living_accommodation_remarks || ''
            },
            {
              facility: 'Separate sanitary, washing and sleeping facilities (if applicable)',
            ...
            {
              facility: 'Lactation station (in consonance with DOLE D.O. 143-15)',
            ...
            {
              facility: 'Other workers\' welfare facilities as prescribed by OSHS and other related issuances',
      ...
      {/* Footer */}
      <div className={isMultiPage ? "relative mt-auto pt-8" : "absolute bottom-8 left-8"}>
        <span className="text-sm text-gray-600">Page | 9</span>
      </div>
    </div>
  );
};
