...
interface DeleteModalProps {
  ...
  onClose: () => void;
  onConfirm: () => void;
  deletingPosition?: OrgStructure | null;
  isLoading?: boolean;
}
              ...
              <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 w-[500px]'>
                ...
                <div className='text-xl px-20 text-center'>
                  <p className='text-xl text-gray-600 font-bold'>
                    Are you sure you want to <span className='text-red-500'>delete</span> this position?
                  </p>
                  {deletingPosition && (
                    <div className='mt-4 p-3 bg-gray-50 rounded-lg'>
                      <p className='text-lg font-semibold text-gray-800'>
                        {deletingPosition.position_name}
                      </p>
                    </div>
                  )}
                ...
                <div className='flex justify-center w-full px-4 space-x-8 pt-10 pb-7'>
                  ...
                  <span className='flex w-full rounded-md shadow-sm sm:w-auto'>
                    <button
                      type='button'
                      className='inline-flex justify-center drop-shadow-xl w-full rounded-md border border-transparent px-20 py-2 bg-red-600 text-base leading-6 font-bold text-white shadow-sm hover:bg-red-700 focus:outline-none focus:shadow-outline-red transition ease-in-out duration-150 sm:text-sm sm:leading-5'
