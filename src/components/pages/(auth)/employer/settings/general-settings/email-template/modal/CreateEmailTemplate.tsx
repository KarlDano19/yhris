import { Dispatch, Fragment, useCallback, useEffect, useRef, useState, useMemo } from 'react';
...
export default function CreateEmailTemplateModal({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: Dispatch<boolean> }) {
