              ...
              <div className='relative flex items-center'>
                <div className='w-full h-full bg-[#EAECEE] rounded-md'>
                  <div className='flex justify-between px-4 py-2 h-[50px]'>
                    ...
                    <div>
                      <button className='border-black border rounded-sm px-1 text-black text-sm font-semibold shadow hover:shadow-md focus:shadow-none disabled:opacity-50'>
                        +
                      </button>
                    </div>
                  </div>
                  <div className='px-4 py-2'>
                    <h1 className='text-sm font-semibold text-gray-500 pl-4'>HR approval</h1>
            ...
            <div className='flex-none lg:w-1/2'>
              <div className='relative flex items-center'>
                <div className='w-full h-full'>
                  ...
                  <label htmlFor='name' className='block text-sm font-medium leading-6 text-gray-900 px-4 py-2'>
                    Approvers
                  </label>
