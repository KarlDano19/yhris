...
export default function ScreenApplicantsRightsModal({
  refetch, 
  isOpen,
  setIsOpen,
}: {
  ...
  useEffect(() => {
    if (userRightDetailsData) {
      setValue('view_applicant', userRightDetailsData.view_applicant);
      setValue('schedule_interview', userRightDetailsData.schedule_interview);
    }
              ...
              >
                <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 sm:mx-8 sm:w-full sm:max-w-2xl'>
                  <div className='flex bg-savoy-blue p-2 items-center'>
                    <h3 className='flex-1 text-white ml-2 font-semibold'>Screen Applicants User Rights</h3>
                          ...
                          <div className='lg:col-span-6 grid mt-8 lg:mt-0 grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-x-8 gap-y-5'>
                            <div className='grid-item'>
                              ...
                              <div className='relative mt-2'>
                                <select
                                  id='view_applicant'
                                  {...register('view_applicant', { required: true })}
                            ...
                            <div className='grid-item'>
                              ...
                              <div className='relative mt-2'>
                                <select
                                  ...
                                  {...register('schedule_interview', { required: true })}
                                  className='appearance-none block w-full rounded-md border-0 py-2 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6'
                                >
                                  <option value='true'>Yes</option>
                                  <option value='false'>No</option>
