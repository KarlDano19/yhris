...
export default function JobSuccessfullyInactiveModal({
  setJobInactiveModal,
  isOpen,
  setIsOpen,
}: {
  ...
  setJobInactiveModal: Dispatch<boolean>;
}) {
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white p-7 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg space-y-5">
