...
export default function AddApplicantModal({
  ...
  const { mutate, isLoading: isLoadingAddApplicant } = useAddApplicant(jobPostingId);
        ...
        <Dialog as='div' className='relative z-10' initialFocus={cancelButtonRef} onClose={() => setIsOpen(false)}>
          ...
          <div className='fixed inset-0 z-10 overflow-y-auto'>
            <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
              ...
              >
                <DialogPanel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 sm:mx-8 sm:w-full sm:max-w-screen-2xl'>
                  <div className='flex bg-savoy-blue p-2 items-center'>
                    <h3 className='flex-1 text-white ml-2 font-semibold'>Add Applicant</h3>
                  ...
                  <div className='md:mx-6 my-4'>
                    <form onSubmit={onSubmit}>
                      ...
                      <div className='mt-5 sm:mt-4 sm:flex sm:flex-row-reverse px-4'>
                        ...
                        <button
                          type='submit'
                          disabled={isLoadingAddApplicant}
                          className='inline-flex w-full justify-center rounded-md bg-savoy-blue px-3 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90 sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed'
                        >
                          {isLoadingAddApplicant ? (
                            <div role='status'>
                              <svg
                                aria-hidden='true'
                                className='inline w-6 h-6 mr-2 text-gray-200 animate-spin fill-blue-600'
