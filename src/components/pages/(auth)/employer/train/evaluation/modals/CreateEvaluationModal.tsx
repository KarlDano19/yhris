      ...
      <Dialog as='div' className='relative z-10' initialFocus={cancelButtonRef} onClose={setIsOpen}>
        ...
        <div className='fixed inset-0 z-20 overflow-y-auto'>
          <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
            ...
            >
              <Dialog.Panel className={`${currentTab === 2 ? 'sm:my-8 sm:w-[60%] sm:max-w-2xl': currentTab === 3 ? 'sm:my-8 sm:w-[60%] sm:max-w-2xl':currentTab === 4 ? 'sm:my-8 sm:w-[60%] sm:max-w-2xl': 'sm:my-8 sm:w-[30%] sm:max-w-2xl'}relative overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all`}>
            ...
            <div className='hidden sm:block pt-10 px-10'>
              <div className='md:w-[76%] lg:w-[80%] mx-auto translate-y-[10px]'>
                <div className='w-full bg-gray-200 rounded-full h-1'>
                  <div className={`${currentTab === 2 ? 'w-[30%]' : currentTab === 3 ? 'w-[70%]' : currentTab === 4 ? 'w-[100%]' : 'w-0'} bg-blue-600 h-1 rounded-full`}></div>
                </div>
              </div>
