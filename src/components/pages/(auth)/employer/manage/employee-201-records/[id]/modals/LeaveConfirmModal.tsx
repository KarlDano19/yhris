    ...
    <div data-testid="leave-confirm-modal" className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6">
      ...
      <div className="relative w-full max-w-[260px] sm:max-w-sm rounded-lg sm:rounded-2xl bg-white shadow-xl p-3 sm:p-6">
        ...
        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:flex sm:justify-end gap-2 sm:gap-3">
          <button data-testid="stay-btn" onClick={onCancel} className="rounded-md border border-gray-300 bg-white px-3 py-1.5 text-xs sm:text-sm text-gray-700 hover:bg-gray-50">
            Stay
          </button>
          <button data-testid="discard-btn" onClick={onDiscard} className="rounded-md border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs sm:text-sm text-rose-700 hover:bg-rose-100">
            Discard Changes
          </button>
        </div>
      </div>
