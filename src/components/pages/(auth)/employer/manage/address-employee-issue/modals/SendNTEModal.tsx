...
import { NTE_TEMPLATE, QUILL_FORMATS, QUILL_MODULES } from '@/helpers/constants';
              ...
              >
                <Dialog.Panel className='relative transform overflow-visible rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl'>
                  <div className='flex bg-savoy-blue p-2 items-center'>
                    <h3 className='flex-1 text-white ml-2 font-semibold'>Send NTE via Email</h3>
                      ...
                      <div className='sm:col-span-4'>
                        ...
                        <div className='relative mt-2'>
                          <select
                            ...
                            onChange={(e) => {
                              const currTemplate = NTE_TEMPLATE.find((template) => template.name === e.target.value);
