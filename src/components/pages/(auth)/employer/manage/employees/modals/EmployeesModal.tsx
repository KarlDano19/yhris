                          ...
                          {!viewCV && (
                            <div>
                              ...
                              <div className='flex justify-between'>
                                <button
                                  type='button'
                                  className='w-full md:w-auto mt-10 md:mt-12 mb-7 px-4 py-2 rounded-md text-[#355FD0] border-[1px] border-[#355FD0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:opacity-50'
                                  onClick={() => setViewCV(true)}
                                  tabIndex={-1}
                                  disabled={!!!cvFileDetail.cv}
                                  title={!!!cvFileDetail.cv ? 'No CV/Resume Attached' : ''}
                                >
