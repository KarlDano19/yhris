...
export async function handleProceedUtil({
  ...
  if (documentType === 'notice-to-explain' && employeeId) {
    try {
      ...
      console.log('logoImage:', currentData.logoImage);
      console.log('logoImage type:', typeof currentData.logoImage);
      console.log('sampleLogoPath:', currentData.sampleLogoPath);
      console.log('sampleLogoPath type:', typeof currentData.sampleLogoPath);
      console.log('=======================');
      ...
      if (updateEmployeeIssue) {
        ...
        if (currentData.logoImage) {
          ...
          if (currentData.logoImage instanceof File) {
            uploadData.logo_file = currentData.logoImage;
            console.log('Logo is already a File object');
            ...
            try {
              ...
              uploadData.logo_file = logoFile;
              console.log('Logo converted from base64 to File');
            } catch (error) {
          ...
          try {
            ...
            uploadData.logo_file = logoFile;
            console.log('Sample logo converted to File:', currentData.sampleLogoPath);
          } catch (error) {
        ...
        if (currentData.signature) {
          if (currentData.signature instanceof File) {
            uploadData.signature_file = currentData.signature;
            console.log('Signature is already a File object');
            ...
            try {
              ...
              uploadData.signature_file = signatureFile;
              console.log('Signature converted from base64 to File');
            } catch (error) {
