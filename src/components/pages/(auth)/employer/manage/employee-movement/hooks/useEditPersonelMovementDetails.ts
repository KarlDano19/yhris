...
async function editPersonelMovementDetails(personel_movement_id: number, data: any) {
  try {
...
function useEditPersonelMovementDetails() {
  const query = useMutation((props: any) => editPersonelMovementDetails(props.personel_movement_id, props.data));
  return query;
}

export default useEditPersonelMovementDetails;
