      ...
      {onExport && (
        <div className="absolute top-2 sm:top-8 right-2 sm:right-10 z-10">
          <Menu as='div' className='relative'>
            <MenuButton className='bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-6 py-2 rounded-lg flex items-center gap-1 sm:gap-2 transition-colors disabled:opacity-50 shadow-lg text-sm sm:text-base' disabled={isExporting}>
