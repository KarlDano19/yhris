import { useState, Dispatch, Fragment, useRef } from 'react';
                ...
                <form onSubmit={onSubmit}>
                  <div className='px-4 pt-4 pb-6'>
                        ...
                        <div className='w-1/2'>
                          ...
                          <div className='relative mt-2'>
                            <input
                              id='position'
                              type='number'
                              {...register('employees_slot_from', { required: true })}
                              className='block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6'
                            />
                          </div>
                        </div>
                        <div className='w-1/2'>
                          ...
                          <div className='relative mt-8'>
                            <input
                              id='position'
                              type='number'
                              {...register('employees_slot_to', { required: true })}
                              className='block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6'
                            />
                          </div>
                        </div>
                    ...
                    <div className='sm:col-span-4 mt-2 w-full flex space-x-4'>
                      <div className='w-1/3'>
                        <label htmlFor='reason' className='block text-sm font-medium leading-6 text-gray-900'>
                          Max Redemption<span className='text-red-600'></span>
                        </label>
                        <div className='relative mt-2'>
                          <input
                            id='position'
                            type='number'
                            {...register('maximum_redemption', { required: true })}
                            className='block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6'
                          />
                        </div>
                      </div>
                    ...
                    <div className='sm:col-span-4 mt-2 w-full'>
                      ...
                      <div className='relative mt-2'>
                        ...
                        >
                          ...
                          <option value='Michael Ian'>Michael Ian</option>
                          <option value='Reuel Dave'>Reuel Dave</option>
                        </select>
                        <div className='pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4'>
                          <SelectChevronDown />
                        </div>
                    ...
                    <div className='sm:col-span-4 mt-2 w-full flex space-x-2'>
                      <input type='checkbox' {...register('is_active')} checked className='ml-0.5' />
                      <label htmlFor='reason' className='block text-sm font-medium leading-6 text-gray-900'>
