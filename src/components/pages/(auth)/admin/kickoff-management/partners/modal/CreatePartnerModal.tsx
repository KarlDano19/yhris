...
import { useState, useRef, Dispatch, Fragment } from 'react';
            ...
            >
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="flex bg-savoy-blue p-2 items-center">
                  <h3 className="flex-1 text-white ml-2 font-semibold">Add Partner</h3>
                ...
                <form onSubmit={onSubmit}>
                  <div className="px-4 pt-4 pb-6 space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <input type="checkbox" defaultChecked {...register('is_active')} className="h-4 w-4" />
