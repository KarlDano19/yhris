      ...
      return (
        <tr>
          <td colSpan={7}>
            ...
            <h4 className='text-center text-gray-300 text-sm mb-4'>Please click APPLY NOW! to apply for a job.</h4>
          </td>
        </tr>
      );
    }
            ...
            <div className='-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8'>
              <div className='min-w-full py-2 sm:px-6 lg:px-8'>
                <table className='min-w-full divide-y divide-gray-300 text-center'>
                  <thead>
                    <tr>
                      <th scope='col' className='px-3 py-3.5 text-sm font-semibold text-indigo-dye'>
                        Application Date
                      </th>
                      <th scope='col' className='px-3 py-3.5 text-sm font-semibold text-indigo-dye'>
                        Job Title
