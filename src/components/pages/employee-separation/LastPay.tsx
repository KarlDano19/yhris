...
import { LastPayModal } from '@/types/globals'
import React, { Dispatch } from 'react'

const LastPay = ({ id, isLastPayReleased, setIsLastPayModalOpen }: { id: number, isLastPayReleased: boolean, setIsLastPayModalOpen: Dispatch<LastPayModal> }) => {
  return (
