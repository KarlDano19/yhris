...
export default function SendContractModal({
  ...
  const onSubmit = handleSubmit((data) => {
    if (isOpen) {
      ...
      separationItemsCopy[0].sendContract.template = data.template;
      separationItemsCopy[0].sendContract.to = data.email;
      separationItemsCopy[0].sendContract.message = data.message;
      separationItemsCopy[0].isContractSent = true;
      separationItemsCopy[0].isContractReceived = true;
      separationItemsCopy[0].contractReceivedDate = Intl.DateTimeFormat('en-US').format(new Date());
      reset();
      setIsOpen(false);
