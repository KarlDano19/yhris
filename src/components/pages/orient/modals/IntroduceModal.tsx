...
export default function IntroduceModal({
  ...
  const onSubmit = handleSubmit((data) => {
    if (isOpen) {
      ...
      separationItemsCopy[0].introduce.template = data.template;
      separationItemsCopy[0].introduce.to = data.email;
      separationItemsCopy[0].introduce.message = data.message;
      separationItemsCopy[0].isIntroduceSent = true;
      reset();
      setIsOpen(false);
                ...
                <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl'>
                  <div className='flex bg-savoy-blue p-2 items-center'>
                    <h3 className='flex-1 text-white ml-2 font-semibold'>
                      Introduce Employee to the team via Email
                    </h3>
                    <XCircleIcon
