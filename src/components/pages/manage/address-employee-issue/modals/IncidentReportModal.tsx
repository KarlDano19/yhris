  ...
  const onSubmit = handleSubmit((data) => {
    ...
    const callbackReq = {
      onSuccess: (data: any) => {
        ...
        setIsOpen(false);
        reset();
        // queryClient.refetchQueries({ queryKey: ["employeeIssueItemCache"] });
        refetch()
      },
      onError: (err: any) => {
                    ...
                    <button
                      ...
                      onClick={
                        async()=>{
                          ...
                          if(incomplete){
                            toast.custom(() => <CustomToast message={"You cannot proceed due to incomplete fields. Please review."} type="error" />, {
                              duration: 2000,
                            });
                          }
                        }
