...
export default function InvestigationModal({
  ...
  const onSubmit = handleSubmit((data) => {
    if (isOpen && isOpen.id) {
      ...
      setToSaveData([...employeeIssueItemsCopy]);
      setIsOpen(null);
  ...
  const saveData = () => {
    setEmployeeIssueItems([...toSaveData]);
    toast.custom(
      () => (
  ...
  return (
    <>
      ...
      <ConfirmModal message="Are you sure that you have investigated the reported incident?" isOpen={isConfirmModalOpen} setIsOpen={updateConfirmModal} confirmAction={saveData} />
    </>
  );
}
