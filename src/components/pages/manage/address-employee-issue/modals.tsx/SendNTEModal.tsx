...
export default function SendNTEModal({ isOpen, setIsOpen }: { isOpen: T_DocumentsModal | null, setIsOpen: Dispatch<T_DocumentsModal | null> }) {
    const { register, handleSubmit, reset, watch, formState: { isDirty }, setValue } = useForm<FormValues>({ defaultValues: { template: 'Notice to explain', message: templates[0].message } });
