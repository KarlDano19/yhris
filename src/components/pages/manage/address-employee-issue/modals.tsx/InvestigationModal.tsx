...
export default function InvestigationModal({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: Dispatch<boolean> }) {
                                    ...
                                    <div className="px-4 pt-4 pb-6">
                                        <div>
                                            <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">
                                                Date of Investigation<span className="text-red-600">*</span>
                                            </label>
                                        ...
                                        <div className="grid grid-cols-2 gap-6 mt-4">
                                            ...
                                            <div>
                                                <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">
                                                    Place of Incident<span className="text-red-600">*</span>
                                                </label>
                                                <div className="mt-2">
                                                    <input
                                                        id="incidentPlace"
