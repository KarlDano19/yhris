...
export default function RedemptionCountModal({
  ...
  vouchers: Voucher[]; // Define the type of vouchers
}) {
        ...
        <tr>
          <td colSpan={7}>
            ...
            <h4 className='text-center text-gray-300 text-sm mb-4'>
              Voucher is not been redeemed yet.
            </h4>
          </td>
        </tr>
      );
                ...
                <div className='px-4 pt-4 pb-6'>
                  ...
                  <thead>
                    <tr>
                      <th
                        scope='col'
                        className='py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0 text-center'
                      >
                        Name
                      </th>
