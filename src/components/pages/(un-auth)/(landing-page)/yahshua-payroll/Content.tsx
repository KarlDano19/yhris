        ...
        <main className="min-h-screen pt-16">
          ...
          <section className="pt-28 pb-20 relative overflow-hidden lp-dot-grid-light lp-hero-glow">
            ...
            <div className="lp-section-container relative z-10 text-center">
              <ScrollFadeIn>
                <span className="lp-section-label justify-center mb-5">YAHSHUA PAYROLL</span>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  ...
                  <Link href="/register" className="lp-btn-ghost gap-2">
                  ...
                  return (
                    <ScrollFadeIn key={feature.title} delay={i * 60}>
                      <div className="lp-dark-card p-7 h-full flex flex-col">
                        ...
                        <p className="text-sm text-white/45 leading-relaxed mb-5 flex-1">{feature.description}</p>
                ...
                {integrationApps.map((app, i) => (
                  <ScrollFadeIn key={app.title} delay={i * 80}>
                    <div className="lp-dark-card p-7 h-full flex flex-col">
                      ...
                      <h3 className="text-base font-bold text-white mb-3">{app.title}</h3>
                      <p className="text-sm text-white/45 leading-relaxed mb-5 flex-1">{app.description}</p>
                      <div className="flex flex-wrap gap-2">
                        {app.tags.map((tag) => (
                          <span
                            key={tag}
              ...
              <ScrollFadeIn>
                <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                  <div className="flex items-center gap-6">
                    <div className="rounded-xl px-6 py-4 flex flex-col items-center gap-1.5 min-w-[160px]" style={{ background: "hsl(var(--lp-surface))", border: "1px solid rgba(255,255,255,0.1)" }}>
                  ...
                  <div className="max-w-xs">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-3 tracking-tight">Perfect integration with YAHSHUA HRIS.</h2>
