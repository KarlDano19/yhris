        ...
        <main className="min-h-screen pt-16">
          ...
          <div className="lp-section-container max-w-3xl mx-auto pt-10 pb-0">
            <div className="relative w-full rounded-2xl overflow-hidden" style={{ height: "360px" }}>
              <Image
                src="/blog/dole-compliance-2026.png"
                alt="DOLE Compliance Requirements Every Philippine Employer Must Know in 2026"
                fill
                ...
                style={{ color: "#374151", lineHeight: "1.8" }}>
                  ...
                  <div style={{ background: "rgba(255,193,7,0.06)", border: "1px solid rgba(255,193,7,0.25)", borderRadius: "12px", padding: "1.25rem 1.5rem", marginBottom: "2.5rem" }}>
                    <p style={{ margin: 0, fontSize: "0.9rem", color: "#374151" }}>
                      <strong style={{ color: "hsl(38, 92%, 38%)" }}>Regulatory update:</strong> DOLE Department Order No. 252-25 took effect on May 16, 2025, replacing the previous DO 198-18. This guide reflects the updated requirements under DO 252-25.
                    </p>
                  </div>
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.9rem" }}>
                      <thead>
                        <tr style={{ borderBottom: "1px solid rgba(0,0,0,0.1)" }}>
                          <th style={{ textAlign: "left", padding: "0.75rem 1rem", color: "#6b7280", fontWeight: "600" }}>Report</th>
                          <th style={{ textAlign: "left", padding: "0.75rem 1rem", color: "#6b7280", fontWeight: "600" }}>Deadline</th>
                          <th style={{ textAlign: "left", padding: "0.75rem 1rem", color: "#6b7280", fontWeight: "600" }}>Filed With</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} style={{ borderBottom: "1px solid rgba(0,0,0,0.06)", background: i % 2 === 0 ? "rgba(255,193,7,0.03)" : "transparent" }}>
                            <td style={{ padding: "0.75rem 1rem", color: "#374151" }}>{row.report}</td>
                            <td style={{ padding: "0.75rem 1rem", color: "hsl(var(--lp-primary))", fontWeight: "600", whiteSpace: "nowrap" }}>{row.deadline}</td>
                            <td style={{ padding: "0.75rem 1rem", color: "#6b7280" }}>{row.filed}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
          ...
          <section className="py-16" style={{ background: "#FFFBF0", borderTop: "1px solid rgba(255,193,7,0.2)" }}>
            <div className="lp-section-container max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4" style={{ lineHeight: "1.3" }}>
                Stop rebuilding WAIR reports from scratch every month.
              </h2>
              <p className="text-gray-500 text-base leading-relaxed mb-8 max-w-xl mx-auto">
                YAHSHUA HRIS generates your WAIR, EC Logbook, Annual Medical Report, and OSH annual report directly from your HR data. Correct format, ready to submit, every reporting period.
              </p>
              <a
                href="https://calendly.com/clientrelations-abba/presentation?utm_source=website&utm_medium=blog&utm_campaign=dole_compliance"
                target="_blank"
              ...
              >
                See how DOLE compliance works in YAHSHUA <ArrowRight className="w-4 h-4" />
              </a>
            </div>
          </section>
