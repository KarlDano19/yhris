    ...
    <div style={{ background: "#ffffff" }}>
        <main className="min-h-screen pt-16">
          <div className="lp-section-container py-20 max-w-3xl">
            ...
            <h2 className="text-lg font-bold text-gray-900 pt-8 mb-3">Terms of Service Agreement</h2>
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">1. Acceptance of Terms</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
              By accessing and using this Service, you accept and agree to be bound by the terms and provision of this
              agreement. If you do not agree to abide by the above, please do not use this Service.
            </p>

            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">2. Description of Service</h3>
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">3. User Accounts and Registration</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">4. Acceptable Use Policy</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-3">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">5. Privacy and Data Protection</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">6. Subscription and Payment Terms</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">7. Intellectual Property Rights</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">8. Service Availability and Modifications</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">9. Limitation of Liability</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">10. Indemnification</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">11. Termination</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">12. Governing Law and Jurisdiction</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">13. Changes to Terms</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-base font-bold text-gray-900 pt-8 mb-3">14. Contact Information</h3>
            <p className="text-justify text-gray-600 leading-relaxed mb-4">
              If you have any questions about these Terms of Service, please contact us:
            </p>
            <div className="mt-6 p-6 rounded-xl space-y-1" style={{ background: "#FFFBF0", border: "1px solid rgba(255,193,7,0.25)" }}>
              <p className="text-gray-900 font-bold">YAHSHUA Outsourcing Worldwide, Inc.</p>
              ...
              <p className="text-gray-600">Email: <span className="text-primary font-semibold">clientrelations@abba.works</span></p>
              <p className="text-gray-600">Phone: <span className="font-semibold text-gray-800">0917-625-5249</span></p>
            </div>
            <p className="text-gray-400 text-xs mt-8">Date last updated: 25 June 2025</p>
          </div>
        </main>
    </div>
  );
