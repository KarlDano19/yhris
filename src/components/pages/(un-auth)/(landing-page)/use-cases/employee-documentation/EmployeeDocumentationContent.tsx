        ...
        <main className="min-h-screen pt-16">
          ...
          <section className="pt-28 pb-20 relative overflow-hidden lp-dot-grid-light lp-hero-glow">
            ...
            <div className="lp-section-container relative z-10 text-center">
              <ScrollFadeIn>
                <span className="lp-section-label justify-center mb-3">USE CASE</span>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  ...
                  <Link href="/use-cases" className="lp-btn-ghost-dark gap-2">
                    View All Use Cases
                  </Link>
                </div>
              </ScrollFadeIn>
            ...
            <div className="lp-section-container">
              <ScrollFadeIn>
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 tracking-tight">From Filing Cabinets to Digital Excellence</h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 leading-relaxed">Davao Construction Corp had rooms full of filing cabinets, lost employee records, and compliance nightmares. Finding a single document took hours, and audits were stressful ordeals with missing paperwork.</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">The Solution</p>
                      <p className="text-sm text-gray-500 leading-relaxed">YAHSHUA HRIS digitized their entire document system with secure cloud storage, organized filing structure, and systematic management that keeps everything compliant and accessible.</p>
                    </div>
                  </div>
                  <div className="lp-light-card p-7">
            ...
            <div className="lp-section-container">
              <ScrollFadeIn>
                <div className="text-center mb-14">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Powerful documentation features.</h2>
                </div>
              </ScrollFadeIn>
                ...
                {features.map((f, i) => {
                  ...
                  return (
                    <ScrollFadeIn key={f.title} delay={i * 60}>
                      <div className="lp-light-card p-7 flex gap-5">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: "rgba(255,193,7,0.1)", border: "1px solid rgba(255,193,7,0.2)" }}>
            ...
            <div className="lp-section-container">
              <ScrollFadeIn>
                <div className="text-center mb-14">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Comprehensive document management.</h2>
                </div>
              </ScrollFadeIn>
                    ...
                    <div className="lp-light-card p-6">
                      ...
                      <ul className="space-y-2">
                        {cat.documents.map((doc) => (
                          <li key={doc} className="flex items-start gap-2 text-xs text-gray-500 leading-relaxed">
            ...
            <div className="lp-section-container">
              <ScrollFadeIn>
                <div className="text-center mb-14">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Document management in 4 steps.</h2>
                </div>
              </ScrollFadeIn>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {workflowSteps.map((s, i) => {
                  ...
                  return (
                    <ScrollFadeIn key={s.step} delay={i * 60}>
                      <div className="lp-light-card p-6">
                        <span className="text-xs font-mono text-gray-300 mb-4 block">{s.step}</span>
                        <div className="w-9 h-9 rounded-lg flex items-center justify-center mb-4" style={{ background: "rgba(255,193,7,0.1)", border: "1px solid rgba(255,193,7,0.2)" }}>
                          <Icon className="w-4 h-4 text-primary" strokeWidth={1.5} />
                        </div>
                        <h3 className="text-sm font-bold text-gray-800 mb-2">{s.label}</h3>
            ...
            <div className="lp-section-container">
              <ScrollFadeIn>
                <div className="text-center mb-14">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Built for compliance and security.</h2>
                </div>
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                  <div className="lp-light-card p-7">
                    <div className="flex items-center gap-2 mb-5">
                      <ShieldCheck className="w-5 h-5 text-primary" strokeWidth={1.5} />
                      <h3 className="text-sm font-bold text-gray-800">Security and Compliance</h3>
                    </div>
                    <ul className="space-y-3">
                  ...
                  <div className="lp-light-card p-7">
                    <div className="flex items-center gap-2 mb-5">
                      ...
                      <h3 className="text-sm font-bold text-gray-800">Document Access Analytics</h3>
                    </div>
                      ...
                      {[
                        ...
                        <div key={row.label} className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            <div className="text-sm font-semibold text-gray-700">{row.value}</div>
                            <div className="text-xs text-primary/80">{row.sub}</div>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          <section className="py-20 md:py-28" style={{ background: "#ffffff" }}>
            <div className="lp-section-container text-center">
              <ScrollFadeIn>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Ready to go paperless?</h2>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  ...
                  <Link href="/use-cases" className="lp-btn-ghost-dark gap-2">View All Use Cases</Link>
                </div>
              </ScrollFadeIn>
            </div>
          </section>
