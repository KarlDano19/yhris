...
const painPoints = [
  {
    icon: Layers,
    title: "Recruitment and performance cost extra",
    body: "GreatDay HR's Basic Starter Package doesn't include recruitment or performance management. Both are sold as add-ons on top of the base plan.",
  },
  {
    icon: Users,
  ...
  {
    icon: FileWarning,
    title: "No guided DOLE reporting module",
    body: "GreatDay HR automates BIR and payroll-side compliance, but doesn't publish a module for company registration, OSH reports, or AERW filing.",
  },
];
          ...
          <div className="lp-section-container relative z-10 text-center">
            <ScrollFadeIn>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <Link href="/vs-greatday" className="lp-btn-ghost-dark gap-2">
            ...
            <ScrollFadeIn>
              <div className="max-w-2xl mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight tracking-tight">
                  Why Philippine SMEs look for a GreatDay HR alternative.
                </h2>
              </div>
            </ScrollFadeIn>
          ...
          <div className="lp-section-container">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <ScrollFadeIn delay={60}>
                <div className="lp-light-card p-7 h-full">
                  <h3 className="text-base font-bold text-gray-900 mb-4">Stick with GreatDay HR if:</h3>
                  <ul className="space-y-3">
                    {stayFor.map((s) => (
                      <li key={s} className="flex items-start gap-3 text-sm text-gray-600">
...
export default GreatdayAlternativeContent;
