...
function Content() {
  return (
    <>
      <Navigation />
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 my-14 mt-24'>
        ...
        <h2 className='text-lg font-bold text-gray-900 pt-8'>Terms of Service Agreement</h2>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>1. Acceptance of Terms</h3>
        <p className='text-justify text-gray-800'>
          By accessing and using this Service, you accept and agree to be bound by the terms and provision of this 
          agreement. If you do not agree to abide by the above, please do not use this Service.
        </p>

        <h3 className='text-lg font-bold text-gray-900 pt-8'>2. Description of Service</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>3. User Accounts and Registration</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>4. Acceptable Use Policy</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>5. Privacy and Data Protection</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>6. Subscription and Payment Terms</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>7. Intellectual Property Rights</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>8. Service Availability and Modifications</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>9. Limitation of Liability</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>10. Indemnification</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>11. Termination</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>12. Governing Law and Jurisdiction</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>13. Changes to Terms</h3>
        <p className='text-justify text-gray-800'>
        ...
        <h3 className='text-lg font-bold text-gray-900 pt-8'>14. Contact Information</h3>
        <p className='text-justify text-gray-800'>
          If you have any questions about these Terms of Service, please contact us:
        </p>
        <p className='text-justify text-gray-800 font-bold pt-8'>YAHSHUA Outsourcing Worldwide, Inc.</p>
        ...
        <p className='text-justify text-gray-800'>
          Email: <span className='font-bold'>clientrelations@abba.works</span>
        </p>
        <p className='text-justify text-gray-800'>
          Phone: <span className='font-bold'>0917-625-5249</span>
        </p>
        <p className='text-justify text-gray-800'>Date last updated: 25 June 2025</p>
      </div>
      <Footer />
    </>
  );
