    ...
    <>
      ...
      <div style={{ background: 'hsl(var(--lp-page))' }}>
        <main className="min-h-screen pt-16">
          ...
          {/* Hero */}
          <section className="pt-20 pb-12 relative overflow-hidden lp-dot-grid-light lp-hero-glow" style={{ borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
          ...
          <article className="py-16">
            <div className="lp-section-container max-w-3xl mx-auto">
              <div className="prose prose-lg max-w-none"
                style={{ color: 'rgba(0,0,0,0.65)', lineHeight: '1.8' }}>
                  ...
                  <div style={{ background: 'rgba(16,185,129,0.07)', border: '1px solid rgba(16,185,129,0.2)', borderRadius: '12px', padding: '1.25rem 1.5rem', marginBottom: '2.5rem' }}>
                    <p style={{ margin: 0, fontSize: '0.9rem', color: 'rgba(0,0,0,0.65)' }}>
                      <strong style={{ color: '#059669' }}>Regulatory update:</strong> DOLE Department Order No. 252-25 took effect on May 16, 2025, replacing the previous DO 198-18. This guide reflects the updated requirements under DO 252-25.
                    </p>
                  </div>

                  {/* Intro */}
                  <p style={{ fontSize: '1.125rem', color: 'rgba(0,0,0,0.7)', marginBottom: '2rem' }}>
                  ...
                  <ul style={{ paddingLeft: '1.5rem', marginBottom: '2rem', listStyleType: 'disc' }}>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Broader coverage.</strong> DO 252-25 now covers residences converted into workplaces (relevant for remote and home-based work arrangements), GOCCs without an original charter, economic zone enterprises, and contracting and subcontracting setups in both private and public sectors.</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Stricter penalties.</strong> The new order introduces progressive fines for repeat violations and a P100,000 daily fine for willful non-compliance. This is a significant escalation from the previous penalty structure.</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Streamlined enforcement.</strong> DOLE labor inspectors now have clearer authority to issue immediate work stoppage orders in cases of imminent danger, with less procedural delay than under the old rules.</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Updated OSH personnel requirements.</strong> Safety officer competency standards have been raised, with specialized training now required for high-risk industries and emerging hazards.</li>
                  </ul>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                      <thead>
                        <tr style={{ borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
                          <th style={{ textAlign: 'left', padding: '0.75rem 1rem', color: 'rgba(0,0,0,0.5)', fontWeight: '600' }}>Report</th>
                          <th style={{ textAlign: 'left', padding: '0.75rem 1rem', color: 'rgba(0,0,0,0.5)', fontWeight: '600' }}>Deadline</th>
                          <th style={{ textAlign: 'left', padding: '0.75rem 1rem', color: 'rgba(0,0,0,0.5)', fontWeight: '600' }}>Filed With</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} style={{ borderBottom: '1px solid rgba(0,0,0,0.06)', background: i % 2 === 0 ? 'rgba(0,0,0,0.02)' : 'transparent' }}>
                            <td style={{ padding: '0.75rem 1rem', color: 'rgba(0,0,0,0.7)' }}>{row.report}</td>
                            <td style={{ padding: '0.75rem 1rem', color: 'hsl(var(--lp-primary))', fontWeight: '600', whiteSpace: 'nowrap' }}>{row.deadline}</td>
                            <td style={{ padding: '0.75rem 1rem', color: 'rgba(0,0,0,0.45)' }}>{row.filed}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <p style={{ marginBottom: '2rem', padding: '1rem 1.25rem', borderLeft: '3px solid rgba(255,193,7,0.6)', background: 'rgba(255,193,7,0.06)', borderRadius: '0 8px 8px 0' }}>
                    <strong style={{ color: '#111827' }}>Common mistake:</strong> Many employers only file WAIR when an incident occurs. Under the current rules, monthly submission is required even with zero incidents. Missing months are treated as non-compliance during inspections.
                  </p>
                  ...
                  <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem', listStyleType: 'disc' }}>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Willful non-compliance:</strong> P100,000 per day until the violation is corrected</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Failure to submit the Annual Medical Report:</strong> P20,000 to P50,000 per day</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Repeat violations:</strong> Progressive fines that increase with each subsequent offense</li>
                    <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: '#111827' }}>Imminent danger situations:</strong> DOLE can issue immediate work stoppage orders without the procedural delays that existed under the old rules</li>
                  </ul>
                  <p style={{ marginBottom: '2.5rem' }}>
                  ...
                  <p style={{ marginBottom: '1rem' }}>
                    <strong style={{ color: '#111827' }}>Submit WAIR every month, not just after incidents.</strong> Set a recurring reminder for the 25th of each month to prepare and submit the monthly WAIR via reports.dole.gov.ph, even if the report shows zero incidents.
                  </p>
                  <p style={{ marginBottom: '1rem' }}>
                    <strong style={{ color: '#111827' }}>Build a compliance calendar with all submission deadlines.</strong> January 30 (Annual Work Accident/Illness Exposure Data), January 31 (Annual OSH Report and AERW), and March 31 (Annual Medical Report) should all be on a shared HR calendar with reminders set at least two weeks in advance.
                  </p>
                  <p style={{ marginBottom: '1rem' }}>
                    <strong style={{ color: '#111827' }}>Centralize incident records from day one.</strong> Every workplace incident, however minor, should be logged immediately in a system that stores it digitally and timestamps it automatically. This eliminates gaps in your EC Logbook and makes monthly WAIR preparation straightforward rather than a manual exercise.
                  </p>
                  <p style={{ marginBottom: '2.5rem' }}>
                    <strong style={{ color: '#111827' }}>Generate reports from your existing HR data, not from scratch.</strong> DOLE-format reports should not be rebuilt manually each submission period. An HRIS that generates these reports directly from your incident and employee data removes manual error and saves the hours typically lost to formatting.
                  </p>
                  ...
                  <div style={{ background: 'hsl(var(--lp-surface))', border: '1px solid rgba(255,193,7,0.2)', borderRadius: '16px', padding: '2rem', marginBottom: '3rem' }}>
                    ...
                    <p style={{ color: 'rgba(0,0,0,0.5)', marginBottom: '1.25rem', fontSize: '0.95rem' }}>
                  ...
                  <div style={{ borderTop: '1px solid rgba(0,0,0,0.07)', paddingTop: '2rem', marginTop: '2rem' }}>
                    <p style={{ color: 'rgba(0,0,0,0.4)', fontSize: '0.85rem' }}>
                      Written by <strong style={{ color: 'rgba(0,0,0,0.6)' }}>YAHSHUA HRIS Team</strong> · Last updated April 2026
                    </p>
                    <p style={{ color: 'rgba(0,0,0,0.3)', fontSize: '0.8rem', marginTop: '0.5rem' }}>
