              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <ScrollFadeIn>
                  <article className="lp-dark-card overflow-hidden h-full flex flex-col">
                    <div className="px-8 py-6" style={{ background: 'hsl(var(--lp-surface-2))', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
                      <p className="text-xs font-semibold uppercase tracking-[0.12em] text-white/40 mb-2">Free Forever</p>
                      <h2 className="text-xl font-bold text-white mb-1">YAHSHUA HRIS Freemium</h2>
                      <p className="text-sm text-white/50">Your digital hiring toolkit, always free</p>
                    </div>
                    <div className="px-8 py-6 flex flex-col flex-1">
                      ...
                      <div className="rounded-lg p-4 mb-6 text-sm" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)' }}>
                        <p className="font-semibold text-white/80 mb-2">Best for</p>
