          ...
          <div className='my-3 text-left sm:mt-3 px-6'>
            <div className='mt-2'>
              <ul>
                ...
                <p className='text-sm'>
                  YAHSHUA-ABBA reserves the right to update or revise this privacy notice at any time to align with
                  evolving policies and legal requirements. Whenever such changes occur, we will diligently inform you
                  by posting the new privacy notice on our website for your information and reference.
                </p>
                ...
                <p className='text-sm mb-4'>
                  ...
                  concerning YAHSHUA-ABBAs data privacy practices, you may reach us through:
                </p>
              </ul>
