            ...
            <div className='mt-2'>
              <ul>
                  ...
                  <div className='space-y-3'>
                    ...
                    <p className='text-sm'>
                        However, adequate policies are in place to ensure appropriate security incident management in line with existing data privacy laws, rules, regulations, and issuances.
                    </p>
                  </div>
