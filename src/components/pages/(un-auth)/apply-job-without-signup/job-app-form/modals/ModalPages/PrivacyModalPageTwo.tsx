          ...
          <div className='my-3 text-left sm:mt-3 px-6'>
            <div className='mt-2'>
              <ul>
                ...
                <p className='text-sm'>
                  This Privacy Notice is for the YAHSHUA-ABBA website. These functionalities enable YAHSHUA-ABBA to
                  collect and process your personal information.
                </p>
                <li className='text-base font-semibold mb-3 mt-6'>
                  III. Personal Information Collected and Manner of Collection
                </li>
                <div className='space-y-3'>
                  <p className='text-sm'>
                    We collect the following personal information from you when you book a call or inquire about
                    YAHSHUA-ABBA’s products and services:
                  </p>
                  ...
                  <p className='text-sm'>
                    Moreover, we may collect other personal information that is relevant and necessary for delivering
                    our products or services, as specified in our Terms of Service (ToS) or other client-specific
                    agreements.
                  </p>
                </div>
                <li className='text-base font-semibold mb-3 mt-6'>
                  IV. Basis, Use, and Purpose for Processing of Personal Information
                </li>
                <div className='space-y-3'>
                  <p className='text-sm'>
                    While your consent may be solicited to process your personal information, we may also process
                    personal information without your consent, such as when processing is allowed under Section 12 or
                ...
                <div className='space-y-3'>
                  <p className='text-sm'>
                    We exclusively utilize tokens for user and web browser identification to facilitate authentication
                    when visiting our website, and we do not use any other cookies for this or for any other purpose.
                  </p>
                </div>
              </ul>
            </div>
