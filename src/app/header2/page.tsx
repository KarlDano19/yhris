          ...
          <Client>
              ...
              >
                  ...
                  >
                      ...
                      <h1 className="font-bold" style={{ display: "flex",alignItems:'center',fontFamily:'Golos Text',fontStyle:'normal',fontWeight:'600',fontSize:'30px',lineHeight:'24px'}}>
                  ...
                  <div className="grow">
                      <div className="flex items-center justify-end gap-2 md:gap-8">
                          <img src="/header2.png" height="29px" width="29px" />
...
alignItems: 'center',
textAlign: 'right',
color: '#2C3F58'}}>The ABBA Initiative</p>
                          <div
