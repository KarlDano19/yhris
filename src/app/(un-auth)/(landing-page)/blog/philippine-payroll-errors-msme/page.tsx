...
export const metadata: Metadata = {
  title: 'The ₱480,000 Wake-Up Call: What Philippine Payroll Errors Actually Cost MSMEs | YAHSHUA HRIS',
  ...
  twitter: {
    ...
    title: 'What Philippine Payroll Errors Actually Cost MSMEs in 2026',
