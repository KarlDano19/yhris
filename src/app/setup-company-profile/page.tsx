                            ...
                            <div className="details ID">
                                ...
                                <div className="fields">
                                    <div className="input-field">
                                        ...
                                        <input type="text" placeholder="Enter your email" value={formValues.industryType} onChange={(event) => setFormValues({ ...formValues, industryType: event.target.value })} required></input>
                                    </div>

                                    <div className="input-field">
                                        <label>No.of Employees<span className="required">*</span></label>
                                        <input type="number" placeholder="Enter mobile number" value={formValues.numberOfEmployees} onChange={(event) => setFormValues({ ...formValues, numberOfEmployees: event.target.value })} required></input>
                                    </div>

                                    <div className="input-field">
                                        <label>Work Set-up</label>
                                        <input type="text" placeholder="Enter Work Setup Type" value={formValues.workSetup} onChange={(event) => setFormValues({ ...formValues, workSetup: event.target.value })} required></input>
                                    </div>
                                </div>
                            </div>
