...
const Profile: React.FC = () => {
  ...
  const [modal2Open, setModal2Open ] = useState<boolean>(true);
  ...
  useEffect(() => {
    if (modal2Open) {
      document.body.classList.remove("modal2Open");
    } else {
      document.body.classList.add("modal2Open");
    }
  }, [modal2Open]);

  return (
    <>
     <ReactModal isOpen={modal2Open}
        style={{
          overlay: {
            borderRadius: "50px",
            width: "515px",
          ...
          >
            <div className="details personal">
              ...
              >
                <div
                  ...
                  style={{ display: "flex", flexBasis: "15%" }}
                >
                  <img
                    src="userIcon.png"
                    style={{
              ...
              <div className="details ID">
                ...
                <div className="fields">
                  <div className="input-field">
                    <label>
                      Type of Industry<span className="required">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="input-field">
                    ...
                    <input
                      type="text"
                      placeholder="Enter Work Setup Type"
                      value={formValues.workSetup}
                      onChange={(event) =>
                        setFormValues({
                          ...formValues,
                          workSetup: event.target.value,
                        })
                      }
                      required
                    ></input>
            ...
            <div className="details ID2">
              ...
              <div className="fields">
                ...
                <div className="input-field">
                  <label>
                    Town/Brgy.<span className="required">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder="Enter Town details"
                    value={formValues.town}
                    onChange={(event) =>
                      setFormValues({ ...formValues, town: event.target.value })
                    }
                    required
                  ></input>
                </div>
        ...
        <div className="popupModal flex flex-col items-center justify-center">
          <div className="flex flex-col items-center justify-center mb-4">
            <div className="flex items-center justify-center rounded-full mb-4">
              <img
                src="congrats.png"
                style={{ width: "179px", height: "113px" }}
              />
            </div>
            <br />
            ...
            <p
              ...
              style={{ paddingBottom: "50px" }}
            >
              <b>You have sucessfully set-up your company</b>
            </p>
            <button
              className="bg-blue-700 hover:bg-[#355FD0] text-[#FFFFFF] py-2 px-4 rounded"
              style={{
