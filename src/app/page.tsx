...
export default function Login() {
  ...
  function handleClick() {
    router.push('/setup-company-profile'); // Replace '/other-page' with the path of the page you want to redirect to
  }
        ...
        >
          ...
          >
            <div className="relative">
              <Input type="email" size="large" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required prefix={<BiEnvelope style={{color:'#355FD0'}} />} />
              {/* {emailError && <p style={{ color: 'red' }}>{emailError}</p>} */}
            </div>
            <div className="relative">
              <Input type="password" size="large" placeholder="password" required prefix={<BiLock  style={{color:'#355FD0'}}/>} />
