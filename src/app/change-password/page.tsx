            ...
            <section className="min-h-screen flex items-center justify-center">
                <div className="flex rounded-2xl shadow-lg max-w-screen-80 p-5 items-center">
                    <div className="md:w-1/2 px-8 md:px-16">
                        <h2 className="font-bold text-2xl text-[rgb(72,61,139)]">Change Your Password</h2>
                        <p className="text-xs mt-4 text-[rgb(169,169,169)]">Please make sure your password contains one lowercase letter,one number and atleast 6 character long</p>
              ...
              >
                <Input.Password placeholder="Confirm Password" />
                            ...
                            <button className="bg-[rgb(65,105,225)] rounded-xl text-white py-2 hover:scale-105 duration-300" type='submit' >Change Password</button>
