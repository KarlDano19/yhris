...
interface WarningRedProps {
  className?: string;
}

const WarningRed = ({ className }: WarningRedProps) => {
  return (
    <div className={className}>
      <svg viewBox="0 0 104 104" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
